 ...
 *
 * Request body:
 *   { configToken, refreshToken?, appName?, botName? }
 *
 * Response (success):
 ...
 * optional `appName` overrides the human-facing display_information.name;
 * optional `botName` overrides features.bot_user.display_name.
 *
